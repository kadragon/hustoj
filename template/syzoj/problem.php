<?php
          if($pr_flag){
            ...
            $id=$row['problem_id'];
            $show_title=$PID[$pid].": ".$row['title']." - $OJ_NAME";
          }
?>
...
<div class="ui center aligned grid">
    <div class="row">
      ...
      <div class="row" style="margin-top: -15px">
          <span class="ui label">메모리제한：<?php echo $row['memory_limit']; ?> MB</span>
      ...
      <div class="row" style="margin-top: -23px">
          ...
          <span class="ui label">채점방식：<?php if($row['spj']) echo "Special Judge"; else echo "Judge" ; ?></span>
          <span class="ui label">업로더：<span id='creator'></span></span>
      </div>
      <div class="row" style="margin-top: -23px">
          <span class="ui label">맞은사람：<?php echo $row['submit']; ?></span>
          <span class="ui label">제출횟수：<?php echo $row['accepted']; ?></span>
      </div>
</div>
<div class="ui grid">
  <div class="row">
      ...
      <div class="ui buttons">
          ...
          <?php
            if($pr_flag){
              ...
              echo "<a class=\"small ui positive button\" href=\"status.php?problem_id=$id\">채점상황</a>";
              ...
              echo "<a class=\"small ui positive button\" href=\"status.php?problem_id=$PID[$pid]&cid=$cid\">채점상황</a>";
            }
          ?>
  ...
  <div class="row">
    <div class="column">
      <h4 class="ui top attached block header">설명</h4>
  ...
  <?php if($row['input']){ ?>
    <div class="row">
      <div class="column">
          <h4 class="ui top attached block header">입력</h4>
  ...
  <?php if($row['output']){ ?>
    <div class="row">
        <div class="column">
          <h4 class="ui top attached block header">출력</h4>
  ...
  <?php if(strlen($sinput)){ ?>
    <div class="row">
        <div class="column">
          <h4 class="ui top attached block header">입력 예시
  ...
  <?php if(strlen($sinput)){ ?>
    <div class="row">
        <div class="column">
          <h4 class="ui top attached block header">출력 예시
          <span class="copy" id="copyout" data-clipboard-text="<?php echo ($soutput); ?>">출력</span>
          </h4>
  ...
  <?php if($row['hint']){ ?>
    <div class="row">
        <div class="column">
          <h4 class="ui top attached block header">문제 힌트</h4>
