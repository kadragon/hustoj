    ...
    <div class="row" style="white-space: nowrap; ">
          ...
          <form action="" method="get">
            <div class="ui search" style="width: 280px; height: 28px; margin-top: -5.3px; ">
              <div class="ui left icon input" style="width: 100%; ">
                <input class="prompt" style="width: 100%; " type="text" value="" placeholder="" name="search">
      ...
      <div class="nine wide right aligned column">
        ...
        <div style="margin-left: 10px; display: inline-block; ">
            ...
            <a style="margin-left: 10px; " href="category.php" class="ui labeled icon mini green button"><i class="plus icon"></i> 태그추가</a>
  ...
  <table class="ui very basic center aligned table">
    <thead>
      <tr>
        ...
        <th class="left aligned">문제제목</th>
        <th class="one wide">맞은사람</th>
        <th class="one wide">제출횟수</th>
        <th class="one wide">정답률</th>
      </tr>
    </thead>
    <tbody>
