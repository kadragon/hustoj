        ...
        <div class="five wide column">
            <div class="ui card" style="width: 100%; " id="user_card">
                ...
                <div class="extra content">
                    <a><i class="check icon"></i>맞은 문제: <?php echo $AC ?> 개</a>
                        ...
                        <div class="ui grid">
                            <div class="eight wide column">
                                <div class="ui grid">
                                    <div class="row">
                                        <div class="column">
                                           <h4 class="ui top attached block header">Nickname</h4>
                                    ...
                                    <div class="row">
                                        <div class="column">
                                            <h4 class="ui top attached block header">소속</h4>
                                    ...
                                    <div class="row">
                                        <div class="column">
                                            <h4 class="ui top attached block header">풀이된 문제</h4>
