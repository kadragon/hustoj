                ...
                <a href="<?php echo $path_fix?>/userinfo.php?user=<?php echo $_SESSION[$OJ_NAME.'_'.'user_id']?>"
                    ...
                    <div class="ui simple dropdown item">
                        ...
                        <div class="menu">
                            ...
                            <a class="item" href="<?php echo $path_fix ?>/admin"><i class="settings icon"></i>관리자</a>
                            <?php } ?>
                            <a class="item" href="<?php echo $path_fix?>/logout.php"><i class="power icon"></i>로그아웃</a>
                        </div>
                    </div>
                </a>
                <?php } else { ?>
